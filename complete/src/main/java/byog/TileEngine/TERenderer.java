...
/**
 *
 *  *-------- PROVIDED CODE, NOT BY DAVID ROBINSON ---------
 *
...
public class TERenderer {
    ...
    public void renderFrame(TETile[][] world) {
        ...
        if (world[(int) mx][(int) my].description().equals("floor")) {
            StdDraw.text(10, 40 - 5, "floor");
        } else if (world[(int) mx][(int) my].description().equals("wall")) {
            StdDraw.text(10, 40 - 5, "wall");
        }
        else if (world[(int) mx][(int) my].description().equals("flower")){
            StdDraw.text(10, 40 - 5, "player");
        }
        StdDraw.show();
    }
}
